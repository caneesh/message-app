...
const navItems: { id: NavItemId; label: string; icon: (active: boolean) => JSX.Element }[] = [
  {
    id: 'dashboard',
    label: 'Home',
    icon: (active) => (
...
export function PremiumMobileNav({ activeTab, onTabChange }: PremiumMobileNavProps) {
  return (
    <nav
      className={cn(
        ...
        'h-20 px-2',
        'bg-[var(--bg-glass-heavy)] backdrop-blur-xl',
